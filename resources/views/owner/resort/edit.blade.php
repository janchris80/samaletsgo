                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-line">
                                            <input type="text" id="lat" class="form-control" name="lat" value="{{ $resort->lat }}" placeholder="Latitude">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-line">
                                            <input type="text" id="lng" class="form-control" name="lng"value="{{ $resort->lng }}" placeholder="Longitude">
                                        </div>
                                    </div>
                                </div>
                            </div>
